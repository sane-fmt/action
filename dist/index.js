...
},{"./command":"opPA"}],"SMAs":[function(require,module,exports) {
'use strict';
...
},{"./lib/js-yaml.js":"BW56"}],"AsQL":[function(require,module,exports) {
"use strict";
...
},{}],"Nh41":[function(require,module,exports) {
"use strict";
...
const CONTAINER = os_1.tmpdir();

function prvTempPath(prefix, suffix, existingNames = fs_1.readdirSync(CONTAINER)) {
  const basename = [prefix, Math.random().toString(36).slice(2), Date.now().toString(36), suffix].join('');
  return existingNames.includes(basename) ? prvTempPath(prefix, suffix, existingNames) : path_1.join(CONTAINER, basename);
}

exports.tempPath = (prefix = 'tmp.', suffix = '') => prvTempPath(prefix, suffix);

exports.getContainer = () => CONTAINER;

exports.default = exports.tempPath;
...
},{"@actions/core":"RNev","js-yaml":"fmFj","node-fetch":"AsQL","unique-temp-path":"Nh41","./upstream-version.json":"pt3V"}]},{},["QCba"], null)
